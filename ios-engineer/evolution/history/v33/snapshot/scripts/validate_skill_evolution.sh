...
echo "[3/8] Validate referenced files exist"
missing=0
...
echo "[4/8] Validate layering guardrails"
...
echo "[5/8] Validate internal markdown links"
ruby <<'RUBY'
broken = 0
...
echo "[6/8] Validate no orphan references"
ruby <<'RUBY'
referenced = {}
# SKILL.md 直接引用
...
echo "[7/8] Validate unique ownership + retired word regression"
ruby <<'RUBY'
...
echo "[8/8] Validate snapshot consistency with active version"
