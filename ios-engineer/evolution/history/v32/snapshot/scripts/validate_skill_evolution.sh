...
echo "[3/7] Validate referenced files exist"
missing=0
...
echo "[4/7] Validate layering guardrails"
...
echo "[5/7] Validate internal markdown links"
ruby <<'RUBY'
broken = 0
...
echo "[6/7] Validate no orphan references"
ruby <<'RUBY'
referenced = {}
# SKILL.md 直接引用
...
echo "[7/7] Validate unique ownership + retired word regression"
ruby <<'RUBY'
