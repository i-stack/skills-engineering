...
- [IR-009] 统一遵守 [ios_conventions.md](references/ios_conventions.md)。
...
| [SYM-007] 架构分析 / 架构体检 / 项目健康度 / 技术债盘点 / 系统性风险 / 当前架构有没有问题 | [architecture_analysis.md](references/architecture_analysis.md) | 需要具体修法追加 [architecture_and_network.md](references/architecture_and_network.md)；路线图与迁移风险追加 [migration_strategy.md](references/migration_strategy.md) |
...
- [ROUTE-018] **Skill 自进化 / 规则缺失冲突退役**：主读 [self_evolution.md](references/self_evolution.md)；需要验证场景追加 [validation_scenarios.md](references/validation_scenarios.md)。
- [ROUTE-019] **Skill 验证场景**：主读 [validation_scenarios.md](references/validation_scenarios.md)。
