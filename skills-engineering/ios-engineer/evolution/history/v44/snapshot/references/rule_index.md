...
| SYM-007 | active | 架构分析 / 项目健康度 / 技术债盘点 → architecture_analysis.md | 同上 |
...
| ROUTE-018 | active | Skill 自进化 / 规则缺失冲突退役 → self_evolution.md | 同上 |
| ROUTE-019 | active | Skill 验证场景 → validation_scenarios.md | 同上 |
