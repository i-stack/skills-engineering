...
- 版本状态保存在 `evolution/active_version.json`；提案、历史快照分别存放在 `evolution/proposals/` 和 `evolution/history/`。
...
- 晋升时使用 [scripts/promote_skill_evolution.sh](../scripts/promote_skill_evolution.sh) 归档当前稳定快照并更新 active 版本。
