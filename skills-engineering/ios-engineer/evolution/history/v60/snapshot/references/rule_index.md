...
| 任务分流主关键词集 | [SKILL.md](../SKILL.md) ROUTE 表 | 本文件 ROUTE-NNN 摘要列；[mcp_control.md](mcp_control.md)（按工具预算分流） | 改 SKILL.md ROUTE 关键词必须同步本文件摘要列；新增 ROUTE 必须同步 [scripts/validate_rule_ids.sh](../scripts/validate_rule_ids.sh) 双向断言 |
